...
cat ~/.config/hypr/eww/eww.yuck_template | sed -e "s/{{monitor1}}/monitor $BOTID/g" -e "s/{{monitor0}}/monitor $TOPID/g" > ~/.config/hypr/eww/eww.yuck
echo $BOT $BOTID
echo $TOP $TOPID

rm ~/.config/hypr/scripts/fixMonitors.sh
ln -s ~/.config/hypr/scripts/fixMonitors1.sh ~/.config/hypr/scripts/fixMonitors.sh
